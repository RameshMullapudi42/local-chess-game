    ...
    <>
      <div className={`${styles["col-12"]} ${styles.chessBoardPage}`}>
        <div className={styles.player1Stats}>
          ...
          <div className={styles.playerStatsHeader}>
            ...
            <div className={`${styles.player1Avatar} ${isPlayer1Turn && styles.nextPlayerStyle}`} />
          </div>
        ...
        <div className={styles.player2Stats}>
          <div className={styles.playerStatsHeader}>
           <b> {players[1].playerName}</b>
            <div className={`${styles.player2Avatar} ${!isPlayer1Turn && styles.nextPlayerStyle}`} />
          </div>
          <div className={styles.playerStatsBody}>
            {
              lostPieces !== null && lostPieces.map(element => {
      ...
      {gameStatus === "Checkmate" &&
        <div id="gameStatusSection" className={`${styles.gameStatusSection} ${styles.checkmate}`}>
          Checkmate! <br />{ isPlayer1Turn ? (players[1].playerName) : (players[0].playerName)} won
        </div>
      }
      {gameStatus === "Check" &&
